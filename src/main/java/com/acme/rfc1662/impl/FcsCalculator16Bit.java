...
public class FcsCalculator16Bit implements IFCSCalculator {
    ...
    @ArrayLen(256)
    int[] fcstab = new int[] { 0x0000, 0x1189, 0x2312, 0x329b, 0x4624, 0x57ad, 0x6536, 0x74bf, 0x8c48, 0x9dc1, 0xaf5a,
    ...
    public int calculate(final byte[] data) {
        int trialfcs = pppfcs16(FcsCalculator16Bit.PPPINITFCS16, data);
        trialfcs ^= 0xffff; /* complement */

        return trialfcs;
    }

    private int pppfcs16(final int init, final byte[] data) {

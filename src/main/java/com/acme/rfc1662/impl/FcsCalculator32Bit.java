...
public class FcsCalculator32Bit implements IFCSCalculator {

    private static final int PPPINITFCS32 = 0xffffffff;

    int [] fcstab = new int[] { 0x00000000, 0x77073096, 0xee0e612c, 0x990951ba, 0x076dc419, 0x706af48f, 0xe963a535,
    ...
    @Override
    public int calculate(final byte[] data) {
        int trialfcs = pppfcs32(PPPINITFCS32, data);
        trialfcs ^= 0xffffffff; /* complement */

        return trialfcs;
    }

    private int pppfcs32(final int init, final byte[] data) {
